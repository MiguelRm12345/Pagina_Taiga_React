        ...
        <div className="row d-flex flex-row gap-5 pt-3">
          ...
          <div className="col-sm">
            ...
            <div className="pt-3">
              ...
              <video id="animacion" width="100%" src="./Video/Teaser _ Running Pan (1).mp4" className="rounded-4 p-2"
                controls></video>
          ...
          <div className="col-sm">
            ...
            <div className="pt-3">
              ...
              <video id="animacion" width="100%" src="./Video/animacionnfinalnana___79636d7c21f2963___ (1).mp4"
            ...
            <div className="row row-cols row-cols-sm-3 g-5 pt-5 justify-content-center gap-5">
              ...
              <div className="col col">
                ...
                <div className="card">
                  ...
                  <img src="./img/Lalo5.0.png" className="card-img-top" alt="..." />
              ...
              <div className="col">
                ...
                <div className="card">
                  ...
                  <img src="./img/Razor5.0.png" className="card-img-top" alt="..." />
